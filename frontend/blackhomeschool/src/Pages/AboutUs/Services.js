...
import {
  ...
  import { faAward, faHandsHolding,faBasketShopping ,faHandshake} from "@fortawesome/free-solid-svg-icons";
    ...
    >
      <GridItem w="100%" h="80" bg="blue.500">
        <Center h="100%" w="100%" color="white" className="center">
          ...
          <Heading margin="20px" className="text">BE A VOLUNTEER</Heading>
        </Center>
      </GridItem>
      <GridItem w="100%" h="80" bg="gray.500" >
        <Center h="100%" w="100%" color="white" className="center">
          <FontAwesomeIcon icon={faAward} className="handsUp" />
          <Heading margin="20px" className="text">BE A DONOR</Heading>
        </Center>
      </GridItem>
      <GridItem w="100%" h="80" bg="green.500" >
        <Center h="100%" w="100%" color="white" className="center">
          <FontAwesomeIcon icon={faHandshake} className="handsUp" />
          <Heading margin="20px" className="text">BE A MEMBER</Heading>
        </Center>
      </GridItem>
    </Grid>
  </div>
